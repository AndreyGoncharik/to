...
function addNew() {
  ...
  addNewButton.onclick = function () {
    ...
    document.querySelector('.close-loader .foreground').classList.add('close-loader-move'); //add-new-wrapper
    //itemCardNew.classList.remove("uk-transition-slide-right");
...
function newGroup() {
  ...
  var toggleButtonGroupe = document.getElementById('toggle-canvas-button-group'); // Стрелка верх-низ добавление группы
  ...
  addNewGroupButton.addEventListener('click', () => {
    ...
    inpupNewGroup.classList.remove('hidden', 'uk-transition-slide-right');
  });
}
...
/******/ });
//# sourceMappingURL=main.0b36e4326d4826c7ff55.js.map