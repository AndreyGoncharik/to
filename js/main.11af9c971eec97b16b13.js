...
function addNew() {
  ...
  addNewButton.onclick = function () {
    ...
    itemCardNew.classList.remove("uk-transition-slide-right"); //add-new-wrapper
    ...
    editItem.onclick = function () {
      ...
      this.onclick = function () {
        ...
        if (ksaNum == '') {
          ...
          localStorage[ksaNum] = JSON.stringify(dataArr);
          editClick();
        }
      }; // Del Click
...
/******/ });
//# sourceMappingURL=main.11af9c971eec97b16b13.js.map