...
function alertPopUp(alertTxt) {
  var arertClose = document.querySelector('#alert-close');
  setTimeout(() => {
  ...
  document.querySelector('#alert-text').textContent = alertTxt;
}
...
/******/ });
//# sourceMappingURL=main.48485b628b6e4146c2cc.js.map